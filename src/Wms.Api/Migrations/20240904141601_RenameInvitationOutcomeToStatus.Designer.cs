...
{
    [DbContext(typeof(Db))]
    [Migration("20240904141601_RenameInvitationOutcomeToStatus")]
    partial class RenameInvitationOutcomeToStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wms.Api.Entities.AppFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SeatId")
                        .HasDatabaseName("ix_app_files_seat_id");
            ...
            modelBuilder.Entity("Wms.Api.Entities.SeatBooking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_seat_booking");

                    b.HasIndex("BookingId")
                        .HasDatabaseName("ix_seat_booking_booking_id");

                    b.HasIndex("SeatId")
                        .HasDatabaseName("ix_seat_booking_seat_id");

                    b.ToTable("seat_booking", (string)null);
                });
            ...
            modelBuilder.Entity("Wms.Api.Entities.UserBooking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_booking");

                    b.HasIndex("BookingId")
                        .HasDatabaseName("ix_user_booking_booking_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_booking_user_id");

                    b.ToTable("user_booking", (string)null);
                });
            ...
            modelBuilder.Entity("Wms.Api.Entities.AppFile", b =>
                {
                    b.HasOne("Wms.Api.Entities.Seat", "Seat")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_app_files_seats_seat_id");
            ...
            modelBuilder.Entity("Wms.Api.Entities.Room", b =>
                {
                    ...
                    b.HasOne("Wms.Api.Entities.AppFile", "Photo")
                        .WithOne("Room")
                        .HasForeignKey("Wms.Api.Entities.Room", "PhotoId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_rooms_app_files_photo_id");
            ...
            modelBuilder.Entity("Wms.Api.Entities.SeatBooking", b =>
                {
                    b.HasOne("Wms.Api.Entities.Booking", "Booking")
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_seat_booking_bookings_booking_id");
                    ...
                    b.HasOne("Wms.Api.Entities.Seat", "Seat")
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_seat_booking_seats_seat_id");
            ...
            modelBuilder.Entity("Wms.Api.Entities.Table", b =>
                {
                    b.HasOne("Wms.Api.Entities.AppFile", "Photo")
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_tables_app_files_photo_id");
            ...
            modelBuilder.Entity("Wms.Api.Entities.User", b =>
                {
                    b.HasOne("Wms.Api.Entities.AppFile", "Photo")
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_users_app_files_photo_id");
            ...
            modelBuilder.Entity("Wms.Api.Entities.UserBooking", b =>
                {
                    b.HasOne("Wms.Api.Entities.Booking", "Booking")
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_user_booking_bookings_booking_id");
                    ...
                    b.HasOne("Wms.Api.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_user_booking_users_user_id");
